...
l1_regularization_lambda = 1e-3 # L1 regularization lambda value. If set to 0 then no L1 regularization applied
l2_regularization_lambda = 1e-3 # L1 regularization lambda value. If set to 0 then no L1 regularization applied
...
loss_hist_train, acc_hist_train = train_loop(model, epochs, optimizer, loss_fn, verbose, train_dataloader, preprocessing_transform, backward_method, l1_regularization_lambda, l2_regularization_lambda)
