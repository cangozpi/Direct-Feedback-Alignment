...
class DFA_Linear(nn.Linear):
    ...
    def dfa_backward_hook(module, grad_input, grad_output):
        """
        NOTE: grad_input[0]: grad wrt inputs(X) --> [B, hidden_dim]
        """
        # print(module, type(module))
        # print(len(grad_input), type(grad_input))
        # print(type(grad_input[0]))
        # print(type(grad_input[0]), grad_input[0].shape)
        
        # If layer don't have grad w.r.t input (e.g. first layer)
